                            ...
                            <div class="overflow-hidden">
                                <form method="POST" action="{{ route('products.update', $product->id) }}" class="p-5" enctype="multipart/form-data">
                                    ...
                                    <div class="max-w-sm pt-4">
                                        ...
                                        <div
                                        x-data="{image:'{{ asset('images/products') .'/'. $product->thumbnail_image }}' }"
                                        class="border-2 rounded-lg border-gray-800 border-dashed p-6">
                                            <img :src="image" alt="" class="h-32 aspect-square">
                                            <label for="thumbnail_image">
                                                <span class="inline-block mt-3 bg-blue-500 text-white px-2 py-1 rounded">Change</span>

                                                <input type="file" name="thumbnail_image" class="hidden" id="thumbnail_image" accept="image/*" @change="image = URL.createObjectURL($event.target.files[0])">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="max-w-sm pt-4">
                                        ...
                                        <div
                                        x-data="{image:'{{ asset('images/products') .'/'. $product->thumbnail_image1 }}' }"
                                        class="border-2 rounded-lg border-gray-800 border-dashed p-6">
                                            <img :src="image" alt="" class="h-32 aspect-square">
                                            <label for="thumbnail_image1">
                                                <span class="inline-block mt-3 bg-blue-500 text-white px-2 py-1 rounded">Change</span>
                                                <input type="file" name="thumbnail_image1" class="hidden" id="thumbnail_image1" accept="image/*" @change="image = URL.createObjectURL($event.target.files[0])">
                                            </label>
                                        </div>
                                    </div>
