...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\xampp\htdocs\kahaniapparel\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.C:\\xampp\\htdocs\\kahaniapparel\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'users.show','users.edit','users.update','users.destroy','addresses.index',
'addresses.create','addresses.store','addresses.show','addresses.edit','addresses.update',
'addresses.destroy','cargo-companies.index','cargo-companies.create','cargo-companies.store','cargo-companies.show',
'cargo-companies.edit','cargo-companies.update','cargo-companies.destroy','categories.index','categories.create',
'categories.store','categories.show','categories.edit','categories.update','categories.destroy',
'colors.index','colors.create','colors.store','colors.show','colors.edit',
'colors.update','colors.destroy','products.index','products.create','products.store',
'products.show','products.edit','products.update','products.destroy','orders.index',
'orders.create','orders.store','orders.show','orders.edit','orders.update',
'orders.destroy','order-items.index','order-items.create','order-items.store','order-items.show',
...
'admin.colors.show','admin.orderItems.create','admin.orderItems.index','admin.orderItems.show','admin.orders.create',
'admin.orders.edit','admin.orders.index','admin.orders.show','admin.products.create','admin.products.edit',
'admin.products.index','admin.products.show','admin.users.index','auth.confirm-password','auth.forgot-password',
...
'LOG_STACK','LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','SESSION_DRIVER',
